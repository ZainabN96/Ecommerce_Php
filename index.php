...
<div class="body__overlay"></div>
        ...
        <div class="row px-xl-5">
            <?php
                foreach ( $cat_res as $cateRecord ) {
                   // $image_path = 'assets/img/category/' . $cateRecord['cat_image'];
                    if($cateRecord['cat_image'] == ''){
                        $image_path = 'media/category/cat.png';
                    }
                    else{
                        $image_path = 'media/category/' . $cateRecord['cat_image'];
                    }
                    $cat_id   = $cateRecord['id'];
                        ?>
                    <!-- <div class="col-xl-3 col-lg-4 col-md-6"> -->
                        <?php include 'cat_card.php'; ?>
                <!-- </div> -->
                <?php } ?>
        </div>
    </div>
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['id']?>">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images" width="170" height="173">
                                        </a>
                                    </div>
        ...
        <section class="ftr__product__area ptb--100">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Hot Selling</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
