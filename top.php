...
$meta_title="TheLinenCraft";
$meta_desc="TheLinenCraft";
$meta_keyword="TheLinenCraft";
$meta_url=SITE_PATH;
$meta_image="";
...
<head>
	...
	<link href="images/logo/Logo.jpeg"  rel="icon">
        ...
        <header id="htc__header" class="htc__header__area header--one">
            <div id="sticky-header-with-topbar" class="mainmenu__wrap sticky__header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="menumenu__container clearfix mt-1">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/Logo.jpeg" alt="logo images" width="85" height="85" ></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-7 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        <li class="drop"><a href="index.php">Home</a></li><li class="drop"><a href="shop.php">Shop</a></li>
                                        <?php
